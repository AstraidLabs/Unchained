...
using Unchained.Services.Background.Core;
            ...
            var fileCleanupWork = new BackgroundWorkItem
            {
                ...
                WorkItem = async (provider, ct) =>
                {
                    ...
                    try
                    {
                        ...
                        if (await Task.Run(() => Directory.Exists(tempPath)))
                        {
            ...
            var statsWork = new BackgroundWorkItem
            {
                ...
                WorkItem = async (provider, ct) =>
                {
                    ...
                    try
                    {
                        ...
                        if (!await Task.Run(() => Directory.Exists(statsDir!)))
                            await Task.Run(() => Directory.CreateDirectory(statsDir!));
            ...
            var auditWork = new BackgroundWorkItem
            {
                ...
                WorkItem = async (provider, ct) =>
                {
                    ...
                    try
                    {
                        ...
                        if (!await Task.Run(() => Directory.Exists(auditDir!)))
                            await Task.Run(() => Directory.CreateDirectory(auditDir!));
            ...
            var incidentWork = new BackgroundWorkItem
            {
                ...
                WorkItem = async (provider, ct) =>
                {
                    ...
                    try
                    {
                        ...
                        await Task.Run(() => Directory.CreateDirectory(Path.GetDirectoryName(file)!));
