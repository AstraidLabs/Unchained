...
namespace Unchained.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private readonly IOptions<Configuration.SessionOptions> _sessionOptions;

        public AuthController(
            IMediator mediator,
            ILogger<AuthController> logger,
            IInputSanitizer sanitizer,
            IOptions<Configuration.SessionOptions> sessionOptions)
        {
            _mediator = mediator;
            _logger = logger;
        ...
        public async Task<IActionResult> Login([FromBody] LoginDto loginDto)
        {
            ...
            {
                SessionCookieHelper.SetSessionCookie(Response, result.Data.SessionId, _sessionOptions.Value.SecureCookies);
                return Ok(result);
            }
